        ...
        <form:form action="/editSaveProduct" method="post" modelAttribute="product">
                    ...
                    <div class="row">
                    	<div class="form-group col-md-12">
                    		<div class="col-md-6">
                    			<form:hidden path="productId" class="form-control input-sm" />
                    		</div>
                    	</div>
                    </div>
                    ...
                    <div class="row">
                    	<div class="form-group col-md-12">
                    		<label class="col-md-3" for="name">Product  Name</label>
                    		<div class="col-md-6">
                    ...
                    <div class="row">
                    	<div class="form-group col-md-12">
                    		<label class="col-md-3" for="year">MRP</label>
                    		<div class="col-md-6">
                    ...
                    <div class="row">
                    	<div class="form-group col-md-12">
                    		<label class="col-md-3" for="name">MFG date</label>
                    		<div class="col-md-6">
